...
type
  ...
  /// </para>
  /// </remarks>
  JsRuntimeHandle  = System.Pointer;

const
  /// <summary>
  /// An invalid runtime handle.
  /// </summary>
  JS_INVALID_RUNTIME_HANDLE: JsRuntimeHandle = System.Pointer(0);
...
type
  ...
  /// </remarks>
  JsRef = System.Pointer;

const
  /// <summary>
  /// An invalid reference.
  /// </summary>
  JS_INVALID_REFERENCE: JsRef = System.Pointer(0);
...
type
  ...
  /// </summary>
  /// <remarks>
  /// A JavaScript value is one of the following types of values: undefined, null, booleanean,
...
type
  ...
  JsValueType = (
    ...
    JsString = 3,
    /// <summary>
    /// The value is a JavaScript booleanean value.
    /// </summary>
    JsBoolean = 4,
    /// <summary>
  ...
  /// </returns>
  JsMemoryAllocationCallback = function(callbackState: Pointer; allocationEvent: JsMemoryEventType; allocationSize: Cardinal): boolean; stdcall;
  ...
  JsBeforeCollectCallback = procedure(callbackState: Pointer); stdcall;
  ...
  JsObjectBeforeCollectCallback = procedure(ref: JsRef; callbackState: Pointer); stdcall;
  ...
  JsBackgroundWorkItemCallback = procedure(callbackState: Pointer); stdcall;
  ...
  JsThreadServiceCallback = function(callback: JsBackgroundWorkItemCallback; callbackState: Pointer): boolean; stdcall;
  ...
  JsSerializedScriptUnloadCallback = procedure(sourceContext: JsSourceContext); stdcall;
  ...
  JsNativeFunction = function(callee: JsValueRef; isConstructCall: boolean;  arguments: PJsValueRef; argumentCount: Word; callbackState: Pointer): JsValueRef; stdcall;
  /// <summary>
  ...
  /// <param name="callbackState">The data argument to be passed to the callback.</param>
  JsPromiseContinuationCallback = procedure(task: JsValueRef; callbackState: Pointer); stdcall;
...
/// </returns>
function JsCreateRuntime(attributes: JsRuntimeAttributes; threadService: JsThreadServiceCallback; var runtime: JsRuntimeHandle): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateRuntime' {$ENDIF};
...
///     The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCollectGarbage(runtime: JsRuntimeHandle): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCollectGarbage' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsDisposeRuntime(runtime: JsRuntimeHandle): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsDisposeRuntime' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetRuntimeMemoryUsage(runtime: JsRuntimeHandle; var memoryUsage: NativeUInt): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetRuntimeMemoryUsage' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetRuntimeMemoryLimit(runtime: JsRuntimeHandle; var memoryLimit: NativeUInt): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetRuntimeMemoryLimit' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetRuntimeMemoryLimit(runtime: JsRuntimeHandle; memoryLimit: NativeUInt): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetRuntimeMemoryLimit' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetRuntimeMemoryAllocationCallback(runtime: JsRuntimeHandle; callbackState: Pointer; allocationCallback: JsMemoryAllocationCallback): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetRuntimeMemoryAllocationCallback' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetRuntimeBeforeCollectCallback(runtime: JsRuntimeHandle; callbackState: Pointer; beforeCollectCallback: JsBeforeCollectCallback): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetRuntimeBeforeCollectCallback' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsAddRef(ref: JsRef; var count: cardinal): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsAddRef' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsRelease(ref: JsRef; var count: cardinal): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsRelease' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetObjectBeforeCollectCallback(ref: JsRef; callbackState: Pointer; objectBeforeCollectCallback: JsObjectBeforeCollectCallback): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetObjectBeforeCollectCallback' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateContext(runtime: JsRuntimeHandle; var newContext: JsContextRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateContext' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetCurrentContext(var currentContext: JsContextRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetCurrentContext' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetCurrentContext(context: JsContextRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetCurrentContext' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetContextOfObject(_object: JsValueRef; var context: JsContextRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetContextOfObject' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetContextData(context: JsContextRef; var data: Pointer): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetContextData' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetContextData(context: JsContextRef; data: Pointer): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetContextData' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetRuntime(context: JsContextRef; var runtime: JsRuntimeHandle): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetRuntime' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsIdle(var nextIdleTick: cardinal): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsIdle' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetSymbolFromPropertyId(propertyId: JsPropertyIdRef; var symbol: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetSymbolFromPropertyId' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetPropertyIdType(propertyId: JsPropertyIdRef; var propertyIdType: JsPropertyIdType): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetPropertyIdType' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetPropertyIdFromSymbol(symbol: JsValueRef; var propertyId: JsPropertyIdRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetPropertyIdFromSymbol' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateSymbol(description: JsValueRef; var result: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateSymbol' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetOwnPropertySymbols(_object: JsValueRef; var propertySymbols: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetOwnPropertySymbols' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetUndefinedValue(var undefinedValue: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetUndefinedValue' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetNullValue(var nullValue: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetNullValue' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetTrueValue(var trueValue: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetTrueValue' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetFalseValue(var falseValue: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetFalseValue' {$ENDIF};
...
/// <param name="booleaneanValue">The converted value.</param>
/// <returns>
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsBoolToBoolean(value: boolean; var booleanValue: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsBoolToBoolean' {$ENDIF};

/// <summary>
/// Retrieves the <c>boolean</c> value of a Boolean value.
/// </summary>
/// <param name="value">The value to be converted.</param>
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsBooleanToBool(value: JsValueRef; var boolValue: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsBooleanToBool' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsConvertValueToBoolean(value: JsValueRef; var booleanValue: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsConvertValueToBoolean' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetValueType(value: JsValueRef; var _type: JsValueType): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetValueType' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsDoubleToNumber(doubleValue: double; var value: JsValueRef): JsErrorCode;
    stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsDoubleToNumber' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsIntToNumber(intValue: integer; var value: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsIntToNumber' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsNumberToDouble(value: JsValueRef; var doubleValue: double): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsNumberToDouble' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsNumberToInt(value: JsValueRef; var intValue: integer): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsNumberToInt' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsConvertValueToNumber(value: JsValueRef; var numberValue: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsConvertValueToNumber' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetStringLength(stringValue: JsValueRef; var length: integer): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetStringLength' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsConvertValueToString(value: JsValueRef; var stringValue: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsConvertValueToString' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetGlobalObject(var globalObject: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetGlobalObject' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateObject(var obj: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateObject' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateExternalObject(data: Pointer; finalizeCallback: JsFinalizeCallback; var obj: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateExternalObject' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsConvertValueToObject(value: JsValueRef; var obj: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsConvertValueToObject' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetPrototype(obj: JsValueRef; var prototypeObject: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetPrototype' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetPrototype(obj: JsValueRef; prototypeObject: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetPrototype' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsInstanceOf(obj: JsValueRef; instance: JsValueRef; var result: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsInstanceOf' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetExtensionAllowed(obj: JsValueRef; var result: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetExtensionAllowed' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsPreventExtension(obj: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsPreventExtension' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetProperty(obj: JsValueRef; propertyId: JsPropertyIdRef;  var value: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetProperty' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetOwnPropertyDescriptor(obj: JsValueRef; propertyId: JsPropertyIdRef; var propertyDescriptor: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetOwnPropertyDescriptor' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetOwnPropertyNames(obj: JsValueRef; var propertyNames: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetOwnPropertyNames' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetProperty(obj: JsValueRef; propertyId: JsPropertyIdRef; value: JsValueRef; useStrictRules: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetProperty' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsHasProperty(obj: JsValueRef; propertyId: JsPropertyIdRef; var hasProperty: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsHasProperty' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsDeleteProperty(obj: JsValueRef; propertyId: JsPropertyIdRef; useStrictRules: boolean; var result: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsDeleteProperty' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsDefineProperty(obj: JsValueRef; propertyId: JsPropertyIdRef; propertyDescriptor: JsValueRef; var result: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsDefineProperty' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsHasIndexedProperty(obj: JsValueRef; index: JsValueRef; var result: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsHasIndexedProperty' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetIndexedProperty(obj: JsValueRef; index: JsValueRef; var result: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetIndexedProperty' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetIndexedProperty(obj: JsValueRef; index: JsValueRef; value: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetIndexedProperty' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsDeleteIndexedProperty(obj: JsValueRef; index: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsDeleteIndexedProperty' {$ENDIF};
...
function JsHasIndexedPropertiesExternalData(
            obj: JsValueRef; var value: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsHasIndexedPropertiesExternalData' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetIndexedPropertiesExternalData(obj: JsValueRef; var data: Pointer; var arrayType: JsTypedArrayType; var elementLength: cardinal): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetIndexedPropertiesExternalData' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetIndexedPropertiesToExternalData(obj: JsValueRef; data: Pointer; arrayType: JsTypedArrayType; elementLength: cardinal): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetIndexedPropertiesToExternalData' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsEquals(obj1: JsValueRef; obj2: JsValueRef; var result: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsEquals' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsStrictEquals(obj1: JsValueRef; obj2: JsValueRef; var result: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsStrictEquals' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsHasExternalData(obj: JsValueRef; var value: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsHasExternalData' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetExternalData(obj: JsValueRef; var externalData: Pointer): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetExternalData' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetExternalData(obj: JsValueRef; externalData: Pointer): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetExternalData' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateArray(length: cardinal; var result: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateArray' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateArrayBuffer(byteLength: cardinal; var result: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateArrayBuffer' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateExternalArrayBuffer(data: Pointer; byteLength: cardinal; finalizeCallback: JsFinalizeCallback; callbackState: Pointer; var result: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateExternalArrayBuffer' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateTypedArray(arrayType: JsTypedArrayType; baseArray: JsValueRef; byteOffset: cardinal; elementLength: cardinal; var result: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateTypedArray' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateDataView(arrayBuffer: JsValueRef; byteOffset: cardinal; byteLength: cardinal; var result: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateDataView' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetTypedArrayInfo(typedArray: JsValueRef; var arrayType: JsTypedArrayType; var arrayBuffer: JsValueRef; var byteOffset: cardinal; var byteLength): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetTypedArrayInfo' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetArrayBufferStorage(arrayBuffer: JsValueRef; buffer: ChakraBytePtr; var bufferLength: cardinal): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetArrayBufferStorage' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetTypedArrayStorage(typedArray: JsValueRef; var buffer: ChakraBytePtr; var bufferLength: Cardinal; var arrayType: JsTypedArrayType; var elementSize: integer): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetTypedArrayStorage' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetDataViewStorage(dataView: JsValueRef; var buffer: ChakraBytePtr; var bufferLength: cardinal): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetDataViewStorage' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsConstructObject(func: JsValueRef; arguments: JsValueRef; argumentCount: Word; var result: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsConstructObject' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateFunction(nativeFunction: JsNativeFunction; callbackState: Pointer; var func: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateFunction' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateNamedFunction(name: JsValueRef; nativeFunction: JsNativeFunction; callbackState: Pointer; var func: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateNamedFunction' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateError(message: JsValueRef; var error: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateError' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateRangeError(message: JsValueRef; var error: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateRangeError' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateReferenceError(message: JsValueRef; var error: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateReferenceError' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateSyntaxError(message: JsValueRef; var error: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateSyntaxError' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateTypeError(message: JsValueRef; var error: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateTypeError' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsCreateURIError(message: JsValueRef; var error: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsCreateURIError' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsHasException(var hasException: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsHasException' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsGetAndClearException(var exception: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsGetAndClearException' {$ENDIF};
...
/// </returns>
function JsSetException(exception: JsValueRef): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetException' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsDisableRuntimeExecution(runtime: JsRuntimeHandle): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsDisableRuntimeExecution' {$ENDIF};
...
/// The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsEnableRuntimeExecution(runtime: JsRuntimeHandle): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsEnableRuntimeExecution' {$ENDIF};
...
///     The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsIsRuntimeExecutionDisabled(runtime: JsRuntimeHandle; var isDisabled: boolean): JsErrorCode;
  stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsIsRuntimeExecutionDisabled' {$ENDIF};
...
///     The code <c>JsNoError</c> if the operation succeeded, a failure code otherwise.
/// </returns>
function JsSetPromiseContinuationCallback(promiseContinuationCallback: JsPromiseContinuationCallback; _callbackState: Pointer): JsErrorCode;
    stdcall; external CHAKRA_LIB {$IFDEF MACOS} name '_JsSetPromiseContinuationCallback' {$ENDIF};

{$IF DEFINED(MSWINDOWS)}
  {$INCLUDE ChakraCommonWindows.pas}
{$ENDIF}
